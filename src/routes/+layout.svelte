...
<header class="flex items-center justify-center gap-2 pb-3 text-4xl font-black xl:text-6xl">
...
<footer class="m-4 mb-2 text-center text-sm">
	Content © 2018–{new Date().getFullYear()} Czech Theater, z.s. IČO: 07245904. Website code available
	on
	<a
