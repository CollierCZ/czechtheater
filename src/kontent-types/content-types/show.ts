...
import { type ImageWithCaption } from './image_with_caption';
...
export type Show = IContentItem<{
  ...
  /**
   * Gallery with captions (modular_content)
   * Required: false
   * Id: f54a5e12-8216-4c7e-a864-ec8c3bb9c3e1
   * Codename: gallery_with_captions
   *
   * Include images with a caption to be displayed in a scrolling gallery
   */
  gallery_with_captions: Elements.LinkedItemsElement<ImageWithCaption>;
